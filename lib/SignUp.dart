...
import 'package:practice/Brand/BrndProfSetUp.dart';
...
submit() async {
    if (_formKey.currentState.validate()) {
      ...
      var id = await auth.signUp(email: email, password: pass,role:widget.isBrand?1:0);
      if (id.length != 0) {
        ...
        Navigator.of(context)
          ...
          return widget.isBrand?BrndProfSetUp():InflProfSetUp();
        }));
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        elevation: 0.0,
        title: Text(widget.isBrand ? "Hello, Brand!" : "Hi, Influencer!",
                    ...
                    children: [
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          onSaved: (value)=>namechangeVal(value),
                        ),
                      ),
                      Container(
                        decoration: BoxDecoration(
